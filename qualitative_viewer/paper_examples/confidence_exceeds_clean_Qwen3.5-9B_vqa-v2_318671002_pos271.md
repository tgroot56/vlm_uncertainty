# confidence_exceeds_clean_Qwen3.5-9B_vqa-v2_318671002_pos271

## Caption

Qwen3.5-9B on VQA-v2, sample 318671002: patching the question at token position 271 changes the degraded output from 0 (1.00) to 0 (1.00). The clean output is 1 (0.99). Selection category: confidence exceeds clean.

## LaTeX table row

```latex
Qwen3.5-9B & VQA-v2 & 318671002 & Question & 271 & 1 & 0.99 & 1.00 & 0 & 1.00 & 0.00 & 0 & 1.00 & 0.00 & 0.00 & -0.00 \\
```
