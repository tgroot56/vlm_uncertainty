...
Collect probe results from:
  probe_results/<model_type>/<feature_names_concat>/metrics.json
...
METRICS_FILENAMES = [
    "metrics.json",         # your current name
...
def main():
    ...
    ap.add_argument(
        ...
        help="Root folder containing probe_results/<model_type>/<run_dir>/metrics.json",
    )
    ap.add_argument(
        "--outdir",
        type=str,
